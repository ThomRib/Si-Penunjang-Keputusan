          ...
          <form method="POST">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="tanggal_masuk" id="tanggal_masuk" required="on">
                    <option value="">---</option>
                    <option value="BPKB"<?=($altObj->tanggal_masuk == "BPKB")? "selected=\"on\"" : "" ?>>BPKB</option>
                    <option value="SHM"<?=($altObj->tanggal_masuk == "SHM")? "selected=\"on\"" : "" ?>>SHM</option>
                </select>
            </div>
            <div class="form-group">
                <!--<label for="tanggal_masuk">Tanggal Masuk</label>-->
                ...
                <select class="form-control" name="status" id="status" required="on">
                    <option value="">---</option>
                    <option value="belum kawin"<?=($altObj->status == "belum kawin")? "selected=\"on\"" : "" ?>>belum kawin</option>
                    <option value="kawin"<?=($altObj->status == "kawin")? "selected=\"on\"" : "" ?>>kawin</option>
                </select>
            </div>
            <div class="form-group">
                <label for="no_telp">No telp</label>
                <input type="text" name="no_telp" id="no_telp" class="form-control" autofocus="on" required="on" value="<?php echo $altObj->no_telp; ?>">
            </div>
            <div class="form-group">
