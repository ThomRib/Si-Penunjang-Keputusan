...
?>
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12">
			<div class="jumbotron">
			    ...
			    <p>Pemilihan Nasabah layak kredit pada PT. BPR PRIMA MULTI MAKMUR</p>
			</div>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-4">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">Skor Nasabah & Hasil</h3>
						</div>
						<div class="panel-body">
							<ol>
	...
	<hr>
	<footer class="text-center">Copyright &copy; 2022 PT. BPR PRIMA MULTI MAKMUR</footer>
