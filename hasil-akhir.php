...
<div class="row">
	<div  class="col-xs-12 col-sm-12 col-md-12">
		...
		<br/>
		<table hidden width="100%" class="table table-striped table-bordered">
	    <thead>
	      <tr>
	        <th rowspan="3" class="text-center active">Nasabah</th>
					...
					<tr>
						...
						<?php	$kri2a = $kriObj->readAll(); while ($row2 = $kri2a->fetch(PDO::FETCH_ASSOC)): ?>
							...
							<?php $ran1a = $ranObj->readR($a, $b); while ($row3 = $ran1a->fetch(PDO::FETCH_ASSOC)): ?>
								<td>
									<?php
										echo $nor = number_format($row3['skor_alt_kri'], 3, '.', ',');
										/*
	    ...
	    <thead>
	      <tr>
	        <th rowspan="2" class="text-center active">Nasabah</th>
