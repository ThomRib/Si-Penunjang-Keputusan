				...
				<div class="tab-content">
					...
					<h4>Perangkingan Metode Weighted Product</h4>
						<table width="100%" class="table table-striped table-bordered">
							<thead>
								<tr>
									<th rowspan="3" style="vertical-align: middle" class="text-center">Alternatif</th>
									<th colspan="<?php echo $stmt2->rowCount(); ?>" class="text-center">Kriteria</th>
									<th rowspan="3" style="vertical-align: middle" class="text-center">Vektor S</th>
									<th rowspan="3" style="vertical-align: middle" class="text-center">Vektor V</th>
								</tr>
								<tr>
